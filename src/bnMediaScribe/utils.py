...
def start_text_interation(llama_model: llama.LlamaTextScribe, 
    ...
    if (generate_image):
        ...
        response = input("Do you want to improve the prompt? (yes/no): ").strip().lower()
    else:
        response = "yes"
    ...
    if response == "no":
        ...
        logging.info("Type 'exit' to quit the program and use the last LLaMA response as the prompt.\n")
